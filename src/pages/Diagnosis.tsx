...
const mockAttachmentDiagnosis: DiagnosisData = {
  ...
  advice: "1. 饮食宜清淡，忌食生冷、油腻、甜腻之品；\n2. 适当增加运动，如快走、八段锦，以助脾胃运化；\n3. 注意腹部保暖。",
  thinkingProcess: [
...
const mockDiagnoses: Record<string, DiagnosisData> = {
  "患者男，35岁，IT从业者，长夏就诊。失眠6个月，入睡困难，早醒。伴头晕耳鸣，腰膝酸软，盗汗。舌红少苔，脉细数。": {
    ...
    advice: "1. 忌辛辣、烟酒、浓茶咖啡；\n2. 睡前温水泡脚，可按揉涌泉穴；\n3. 规律作息，避免熬夜，适当进行八段锦等柔和运动；\n4. 7天后复诊，观察睡眠及盗汗改善情况。",
    thinkingProcess: [
  ...
  "患者女，52岁，北方教师，秋季就诊。咳嗽3个月，咽痒，痰少而黏，夜间及晨起加重。伴口干，心烦，睡眠差，大便偏干。舌红少苔，脉细数。": {
    ...
    advice: "1. 忌辛辣、烧烤、温燥之品；\n2. 可用梨皮、麦冬泡水代茶；\n3. 避免用嗓过度，保证睡眠；\n4. 5天后复诊，观察咽痒、大便及睡眠改善情况。",
    thinkingProcess: [
  ...
  "患者男，40岁，岭南高管，夏季就诊。烧心胀满，舌黄厚腻，脉弦滑数。": {
    ...
    advice: "1. 饮食清淡，忌食辛辣肥甘厚味及冰冷之品；\n2. 调节情志，缓解工作压力，避免熬夜；\n3. 3剂后务必复诊，根据湿热消退情况调整用药。",
    thinkingProcess: [
      "【时空】夏季+岭南+高管压力 → 暑湿+肝郁",
  ...
  "患者男，60岁。头晕耳鸣，腰膝酸软，失眠多梦，五心烦热，盗汗，口燥咽干。舌红少苔，脉细数。": {
    ...
    advice: "1. 节制房事，避免过度劳累；\n2. 饮食宜清淡，多食滋阴润燥之品，如百合、银耳；\n3. 保持情绪稳定，避免急躁恼怒。",
    thinkingProcess: [
            ...
            >
              ...
              {msg.diagnosisData && (
                <div className="mt-4 space-y-3">
                  ...
                  {/* 医嘱 */}
                  <div className="bg-white/70 backdrop-blur-md rounded-xl p-3 shadow-sm border border-[#B8D8C8]/40">
                    <h3 className="font-bold text-[#333333] mb-1.5 text-xs tracking-wide">调护建议</h3>
